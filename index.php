...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>JOHN LOUIS URU - WEB DEVELOPER</title>
            ...
            <div class="content">
                ...
                <div class="header" id="header">
                    <div class="content-inner">
                        <p>I'm</p>
                        <h1>John Louis Uru</h1>
                        <h2></h2>
                        <div class="typed-text">Web Developer, PHP Developer, IT Support, Database Analyst</div>
                    </div>
                </div>
                <!-- Header End -->
                ...
                <div class="large-btn">
                    <div class="content-inner">
                        <a class="btn" href="download/resume.pdf" download="JOHN LOUIS S URU - PHP SOFTWARE DEVELOPER.pdf"><i class="fa fa-download" ></i>Resume</a>
                    ...
                    <div class="content-inner">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 col-lg-7">
                                <p>
                                As a <b>PHP</b> <i>Software Developer</i>, my passion lies in harnessing the power of this versatile language to build dynamic and robust web applications. I thrive on the challenge of creating seamless user experiences, optimizing performance, and implementing innovative solutions that meet real-world needs.</p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="skills">
                                    <div class="skill-name">
                                        <p>PHP, MySQL</p><p>90%</p>
                                    </div>
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <div class="skill-name">
                                        <p>HTML5, CSS5, Bootstrap 5</p><p>85%</p>
                                    </div>
                                    <div class="progress">
                            ...
                            <div class="col-md-6">
                                <div class="skills">
                                    <div class="skill-name">
                                        <p>JavaScript: Jquery, Ajax, JSon</p><p>90%</p>
                                    </div>
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <div class="skill-name">
                                        <p>Communication Skill</p><p>90%</p>
                                    </div>
                                    <div class="progress">
                                        <div class="progress-bar" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                ...
                <div class="education" id="education">
                    <div class="content-inner">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <div class="edu-col">
                                    <span>2018 <i>to</i> 2021</span>
                                    <h3>Master Degree</h3>
                                    <p><b>Thesis Writing:</b> Master of Art in Industrial Education, Major in Educational Technology</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="edu-col">
                                    <span>2012 <i>to</i> 2016</span>
                                    <h3>Bachelor Degree</h3>
                                    <p>BSIE Major in Computer Education</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="experience" id="experience">
                    <div class="content-inner">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <div class="exp-col">
                                    <span>Dec 2021 <i>to</i> Dec 2024</span>
                                    <h3>Philippine Coast Guard</h3>
                                    <h4>Philippines</h4>
                                    <h5>Assistant Deputy Chief of Training Staff / Web App Developer</h5>
                                    <p>for Weapons, Communications, Electronics and Information System</p>
                                </div>
                            </div>
                            
                            <div class="col-md-6">
                                <div class="exp-col">
                                    <span>2017 <i>to</i> Present</span>
                                    <h3>Freelance Web Developer</h3>
                                    <h4>Philippines</h4>
                                    <h5>Full Stack Web Developer</h5>
                                    <p>Builds Thesis, Project, Company Websites and Small Business Information System</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="exp-col">
                                    <span>2017 <i>to</i> 2020</span>
                                    <h3>Notre Dame of Greater Manila</h3>
                                    <h4>South Caloocan, Philippines</h4>
                                    <h5>ICT Teacher</h5>
                                    <p>Handled Programming Language, Database Structure & Robotics</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="exp-col">
                                    <span>2016 <i>to</i> 2017</span>
                                    <h3>University of the Philippines - Diliman</h3>
                                    <h4>AMH Engineering Consultant</h4>
                                    <h5>PHP Junior Developer</h5>
                                    <p>Creates Information System in PHP-Based Programming Language</p>
                                </div>
                            </div>
                        </div>
                    </div>
